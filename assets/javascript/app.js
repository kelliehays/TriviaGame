...
//set up time that resets

//start game with timer counting down

//answer questions in alotted time

//questions answered in allotted time - At end of time show score

//Questions answered after time allotted, then "Out of time-your score"
...
$("#start").on("click", start);  
  ...
  function start(){
   ...
   $("#submit-button").show();
    ...
    // $("#results").hide();
     ...
     //  The stop function to end timer and display results
      function stop() {
        clearInterval(intervalId);
        $("#questions-display").hide();
        $("#submit-button").hide();
  ...
  // when submit button is clicked, then results should display
